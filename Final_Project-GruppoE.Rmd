...
### Ripetuta train- test
La divisione del data-set fra quello di train e di test è casuale, quindi per controllare che non siamo stati fortunati nel caso che abbiamo studiato andremo a ripetere il processo 
...
r22 <- ggplot(data = NULL, aes(y = r[2,])) +
  geom_boxplot() +
  ylim(c(0.5,1))+
  ylab("R^2")+
  theme_bw()
