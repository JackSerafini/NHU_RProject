...
```{r, include = T, echo = F}
summary(Data$TPY)
ggplot(data = Data, aes(y = TPY)) +
  geom_boxplot(fill = "yellow") +
  theme_bw() +
  labs(y = "TPY", title = "Distribuzione di TPY") +
  ...
  xlab("")+
  geom_text(data = Data, aes(x = 0.4, y = mean(TPY), label = sprintf("Media: %.2f", mean(TPY))),
            hjust = 0, vjust = 0) +
  geom_text(data = Data, aes(x = 0.4, y = median(TPY) - 10,
                             label = sprintf("Mediana: %.2f", median(TPY))),
            hjust = 0, vjust = 0)
